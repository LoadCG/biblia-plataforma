    ...
    <View className="rounded-3xl bg-cor-fundo-elevado dark:bg-cor-fundo-elevado-dark p-6 mb-4 shadow-sm">
      ...
      <View className="flex-row justify-between mb-6">
        {topConquistas.map((c, index) => {
          ...
          return (
            <View key={c.id} className="items-center flex-1">
              <View 
              ...
              <Text className="text-[10px] text-cor-texto-suave dark:text-cor-texto-suave-dark text-center">
                Saiba mais
              </Text>
            </View>
          );
      ...
      <Pressable className="bg-cor-borda dark:bg-cor-borda-dark self-start px-5 py-2 rounded-full">
